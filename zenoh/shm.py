...
class Deallocate:
    ...
    def __new__(cls, inner_policy: '_AllocPolicy'=JustAlloc(), alt_policy: '_AllocPolicy'=JustAlloc()) -> 'Self':
        ...
...
class Defragment:
    ...
    def __new__(self, inner_policy: '_AllocPolicy'=JustAlloc(), alt_policy: '_AllocPolicy'=JustAlloc()) -> 'Self':
        ...
...
class GarbageCollect:
    ...
    def __new__(self, inner_policy: '_AllocPolicy'=JustAlloc(), alt_policy: '_AllocPolicy'=JustAlloc(), *, safe: 'bool'=True) -> 'Self':
        ...
...
class ShmProvider:
    ...
    def alloc(self, layout: '_IntoMemoryLayout', policy: '_AllocPolicy'=JustAlloc()) -> 'ZShmMut':
