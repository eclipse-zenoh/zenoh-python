...
class Liveliness:
    ...
    def get(self, key_expr: '_IntoKeyExpr', handler: '_RustHandler[Reply] | tuple[Callable[[Reply], Any], Any] | Callable[[Reply], Any] | None'=None, *, timeout: 'float | int | None'=None) -> 'Handler':
        """Query liveliness tokens with matching key expressions."""

    def declare_subscriber(self, key_expr: '_IntoKeyExpr', handler: '_RustHandler[Sample] | tuple[Callable[[Sample], Any], Any] | Callable[[Sample], Any] | None'=None, *, history: 'bool | None'=None) -> 'Subscriber':
...
class Publisher:
    ...
    def put(self, payload: '_IntoZBytes', *, encoding: '_IntoEncoding | None'=None, attachment: '_IntoZBytes | None'=None, timestamp: 'Timestamp | None'=None, source_info: 'SourceInfo | None'=None):
        """Put data."""

    def delete(self, *, attachment: '_IntoZBytes | None'=None, timestamp: 'Timestamp | None'=None, source_info: 'SourceInfo | None'=None):
        """Delete data."""

    def undeclare(self):
        """Undeclares the Publisher, informing the network that it needn't optimize publications for its key expression anymore."""

    def declare_matching_listener(self, handler: '_RustHandler[MatchingStatus] | tuple[Callable[[MatchingStatus], Any], Any] | Callable[[MatchingStatus], Any] | None'=None) -> 'MatchingListener':
...
class Query:
    ...
    def reply(self, key_expr: '_IntoKeyExpr', payload: '_IntoZBytes', *, encoding: '_IntoEncoding | None'=None, congestion_control: 'CongestionControl | None'=None, priority: 'Priority | None'=None, express: 'bool | None'=None, attachment: '_IntoZBytes | None'=None, timestamp: 'Timestamp | None'=None):
    ...
    def reply_del(self, key_expr: '_IntoKeyExpr', *, congestion_control: 'CongestionControl | None'=None, priority: 'Priority | None'=None, express: 'bool | None'=None, attachment: '_IntoZBytes | None'=None, timestamp: 'Timestamp | None'=None):
...
class Querier:
    ...
    def get(self, handler: '_RustHandler[Reply] | tuple[Callable[[Reply], Any], Any] | Callable[[Reply], Any] | None'=None, *, parameters: '_IntoParameters | None'=None, payload: '_IntoZBytes | None'=None, encoding: '_IntoEncoding | None'=None, attachment: '_IntoZBytes | None'=None, source_info: 'SourceInfo | None'=None) -> 'Handler':
        """Sends a query."""
...
class Selector:
    ...
    def __new__(cls, arg: '_IntoKeyExpr | str', /, parameters: '_IntoParameters | None'=None):
        ...
...
class Session:
    ...
    def put(self, key_expr: '_IntoKeyExpr', payload: '_IntoZBytes', *, encoding: '_IntoEncoding | None'=None, congestion_control: 'CongestionControl | None'=None, priority: 'Priority | None'=None, express: 'bool | None'=None, attachment: '_IntoZBytes | None'=None, timestamp: 'Timestamp | None'=None, allowed_destination: 'Locality | None'=None, source_info: 'SourceInfo | None'=None):
        """Put data on zenoh for a given key expression."""

    def delete(self, key_expr: '_IntoKeyExpr', *, congestion_control: 'CongestionControl | None'=None, priority: 'Priority | None'=None, express: 'bool | None'=None, attachment: '_IntoZBytes | None'=None, timestamp: 'Timestamp | None'=None, allowed_destination: 'Locality | None'=None, source_info: 'SourceInfo | None'=None):
        """Delete data for a given key expression."""

    def get(self, selector: '_IntoSelector', handler: '_RustHandler[Reply] | tuple[Callable[[Reply], Any], Any] | Callable[[Reply], Any] | None'=None, *, target: 'QueryTarget | None'=None, consolidation: '_IntoQueryConsolidation | None'=None, timeout: 'float | int | None'=None, congestion_control: 'CongestionControl | None'=None, priority: 'Priority | None'=None, express: 'bool | None'=None, payload: '_IntoZBytes'=None, encoding: '_IntoEncoding | None'=None, attachment: '_IntoZBytes | None'=None, allowed_destination: 'Locality | None'=None, source_info: 'SourceInfo | None'=None) -> 'Handler':
    ...
    def declare_subscriber(self, key_expr: '_IntoKeyExpr', handler: '_RustHandler[Sample] | tuple[Callable[[Sample], Any], Any] | Callable[[Sample], Any] | None'=None, *, allowed_origin: 'Locality | None'=None) -> 'Subscriber':
        """Create a Subscriber for the given key expression."""

    def declare_queryable(self, key_expr: '_IntoKeyExpr', handler: '_RustHandler[Query] | tuple[Callable[[Query], Any], Any] | Callable[[Query], Any] | None'=None, *, complete: 'bool | None'=None, allowed_origin: 'Locality | None'=None) -> 'Queryable':
        """Create a Queryable for the given key expression."""

    def declare_publisher(self, key_expr: '_IntoKeyExpr', *, encoding: '_IntoEncoding | None'=None, congestion_control: 'CongestionControl | None'=None, priority: 'Priority | None'=None, express: 'bool | None'=None, reliability: 'Reliability | None'=None, allowed_destination: 'Locality | None'=None) -> 'Publisher':
        """Create a Publisher for the given key expression."""

    def declare_querier(self, key_expr: '_IntoKeyExpr', *, target: 'QueryTarget | None'=None, consolidation: '_IntoQueryConsolidation | None'=None, timeout: 'float | int | None'=None, congestion_control: 'CongestionControl | None'=None, priority: 'Priority | None'=None, express: 'bool | None'=None, allowed_destination: 'Locality | None'=None) -> 'Querier':
...
class MatchingListener(Generic[_H]):
    ...
    def __iter__(self: 'MatchingListener[Handler[MatchingStatus]]') -> 'Handler[MatchingStatus]':
        ...
...
class SourceInfo:
    ...
    def __new__(cls, source_id: 'EntityGlobalId | None'=None, source_sn: 'SourceSn | None'=None) -> 'Self':
        ...
...
def scout(handler: '_RustHandler[Hello] | tuple[Callable[[Hello], Any], Any] | Callable[[Hello], Any] | None'=None, what: '_IntoWhatAmIMatcher | None'=None, config: 'Config | None'=None) -> 'Scout':
