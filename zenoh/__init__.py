...
class Liveliness:
    ...
    def get(
        ...
        handler: "_RustHandler[Reply] | tuple[Callable[[Reply], Any], Any] | Callable[[Reply], Any] | None" = None,
        *,
...
class Publisher:
    ...
    def declare_matching_listener(
        self,
        handler: "_RustHandler[MatchingStatus] | tuple[Callable[[MatchingStatus], Any], Any] | Callable[[MatchingStatus], Any] | None" = None,
    ) -> "MatchingListener":
...
class Query:
    ...
    def reply_err(
        self, payload: "_IntoZBytes", *, encoding: "_IntoEncoding | None" = None
    ):
...
class Session:
    ...
    def declare_queryable(
        self,
        key_expr: "_IntoKeyExpr",
        handler: "_RustHandler[Query] | tuple[Callable[[Query], Any], Any] | Callable[[Query], Any] | None" = None,
        *,
...
class SourceInfo:
    ...
    def __new__(
        cls,
        source_id: "EntityGlobalId | None" = None,
        source_sn: "SourceSn | None" = None,
    ) -> "Self": ...
...
class ZBytes:
    ...
    **NOTE** Zenoh semantic and protocol take care of sending and receiving bytes
    ...
    def __new__(
        cls, bytes: "bytearray | bytes | str | shm.ZShmMut" = None
    ) -> "Self": ...
...
def scout(
    handler: "_RustHandler[Hello] | tuple[Callable[[Hello], Any], Any] | Callable[[Hello], Any] | None" = None,
